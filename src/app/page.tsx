    ...
    <div className="min-h-screen bg-[#F8F6F1] text-[#1A1A1A]">
      ...
      <main>
        <section className="border-b border-black/10 bg-[linear-gradient(135deg,#E7F8EC_0%,#D8F3DC_52%,#FFF8E8_100%)]">
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-7 px-4 py-8 sm:px-6 sm:py-12 lg:grid-cols-[minmax(0,1fr)_400px] lg:items-center lg:py-16">
            <div className="motion-safe:animate-[riseIn_560ms_ease-out_both]">
              <p className="inline-flex max-w-full rounded-full border border-[#2D6A4F]/20 bg-white/75 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-[#2D6A4F] shadow-sm sm:px-4 sm:tracking-[0.16em]">
                CrowdForge fundraising
              </p>
              <h1 className="mt-5 max-w-3xl font-(--font-display) text-3xl leading-tight text-[#14382F] sm:text-5xl lg:text-6xl">
                Fund the people and ideas moving communities forward.
              </h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-[#1A1A1A]/70 sm:text-lg">
              ...
              <div className="mt-7 grid grid-cols-1 gap-3 rounded-2xl border border-white/70 bg-white/90 p-3 shadow-[0_18px_50px_rgba(20,56,47,0.12)] backdrop-blur transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_60px_rgba(20,56,47,0.16)] sm:grid-cols-[minmax(0,1fr)_auto] sm:rounded-3xl motion-safe:animate-[popIn_520ms_ease-out_120ms_both]">
            ...
            <div className="overflow-hidden rounded-3xl border border-white/70 bg-white shadow-[0_24px_70px_rgba(20,56,47,0.16)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(20,56,47,0.2)] sm:rounded-4xl motion-safe:animate-[riseIn_560ms_ease-out_180ms_both]">
              <div className="bg-[#14382F] px-6 py-5 text-white">
                <p className="text-sm font-semibold text-white/70">
                  Community snapshot
                </p>
                <p className="mt-2 font-(--font-display) text-2xl sm:text-3xl">
        ...
        <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 motion-safe:animate-[riseIn_560ms_ease-out_260ms_both]">
